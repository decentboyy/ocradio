...
async def not_chat(_, m: Message):
    buttons = [
            [
                ...
                InlineKeyboardButton("SUPPORT", url="https://t.me/Iink_ka_adda"),
            ],
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://te.legra.ph/file/279492d88207f648171aa.mp4"),
            ]
         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/4e839766d45935998e9c6.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Make Your Own Bot Like This From The [Source Code](https://te.legra.ph/file/279492d88207f648171aa.mp4) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
